...
EP.em = new Array("::4","::3","::2",":F","::1",":R","::B",":L",":T",":Q",":A",":)",":D",":))",";)",":P",":*)",":*","]:)",":|",":\\","X(",":(",":((",":X",":O","B)",":@",":$",":#","O:)","]:}");
